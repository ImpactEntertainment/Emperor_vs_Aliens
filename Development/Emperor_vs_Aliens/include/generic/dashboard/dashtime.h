...
void dashtime(){
	...
	if(dash_framecap){
		#ifdef SDL
		float framecaptouse=dash_framecap;
		if(dashonpercent!=0)framecaptouse=60.f;
		if(dash_timehaspast<(int)(1000.f/framecaptouse)){
			int delay=(int)(1000.f/framecaptouse)-dash_timehaspast;
			SDL_Delay(delay);
